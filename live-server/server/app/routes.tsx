...
import CheckPost from './pages/check-post.js'
...
let routeDict: Record<string, PageRoute> = {
  ...
  '/check-post': {
    title: title('Check Unclassified Post'),
    description:
      'For admin to check automated post classification flaw or to flag abnormal post',
    menuText: 'Check Post',
    node: <CheckPost.index />,
  },
  '/posts/:id/skip': {
    title: title('Skip Unclassifiable Post'),
    description: 'For admin to skip an abnormal post',
    node: <CheckPost.skip />,
  },
  // '/thermostat': {
